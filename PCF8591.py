...
#check your PCF8591 address by typing in 'sudo i2cdetect -y -1' in terminal.
def setup(Addr):
	global address
	address = Addr
...
def read(chn): #channel
	try:
		...
		print (e)
	return (bus.read_byte(address)*3.3/255) #This is to send the ADC read-out to Pioneer600 as Voltage, based on DAC0 being the voltage source.
